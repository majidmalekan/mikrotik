...
return [
    ...
    |
    */
    'not_found_error' => "این شرکت وام‌دهنده پیدا نشد",
    'company_is_provider' => 'شرکت تأمین کننده نیست',
    'company_is_loans' => 'این شرکت یک  وام‌دهنده نیست',
    ...
    'file_cannot_upload'=>'این فایل غیر قابل اپلود است',
    /*
    |--------------------------------------------------------------------------
    ...
    */
    ...
    'can_not_loan'=>'این وام قابل قسط بندی نیست',
