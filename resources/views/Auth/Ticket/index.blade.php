            ...
            <table class="min-w-full bg-white rounded-lg shadow-md">
                ...
                @foreach ( $tickets as $ticket)
                    <tr class="border-b border-gray-200 hover:bg-gray-100">
                        ...
                        <td class="py-3 px-6 text-center">{{ PriorityTicketEnum::{ ucfirst($ticket?->priority)}()->label }}</td>
                        <td class="py-3 px-6 text-center">{{ DepartmentTicketEnum::{ ucfirst($ticket?->department)}()->label }}</td>
                        <td class="py-3 px-6 text-center">{{ StatusTicketEnum::{ucfirst($ticket?->status)}()->label }}</td>
