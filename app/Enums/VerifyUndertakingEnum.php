 ...
 */
final class VerifyUndertakingEnum extends Enum
{
    ...
    {
        return [
            'Pending' => __('enums.verify_undertaking.Pending'),
            'Accepted' => __('enums.verify_undertaking.Accepted'),
            'Rejected' => __('enums.verify_undertaking.Rejected'),
        ];
    }
}
