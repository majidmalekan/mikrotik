...
final class VerifyProfileEnum extends Enum
{
    /**
    ...
    {
        return [
            'Pending' => __('enums.verify_profile.Pending'),
            'Accepted' => __('enums.verify_profile.Accepted'),
            'Rejected' => __('enums.verify_profile.Rejected'),
        ];
    }
}
