...
final class VerifyOfficialGazetteEnum extends Enum
{
    /**
    ...
    {
        return [
            'Pending' => __('enums.verify_official_gazette.Pending'),
            'Accepted' => __('enums.verify_official_gazette.Accepted'),
            'Rejected' => __('enums.verify_official_gazette.Rejected'),
        ];
    }
}
